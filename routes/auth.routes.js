...
router.get("/login", (req, res) => {
	...
	const scope =
		"user-read-private user-read-email user-modify-playback-state playlist-read-private playlist-read-collaborative user-read-currently-playing user-library-read user-top-read ";
	res.redirect(
